...
def create_model(
    ...
    if pretrained.lower() == 'openai':
        ...
        model = load_openai_model(model_name, device=device, jit=jit, cache_dir=cache_dir, frozen=frozen, proj_type=proj_type)
        ...
        model = CLIP(**model_cfg, frozen=frozen, proj_type=proj_type)
...
def create_model_and_transforms(
    ...
    model = create_model(
        model_name, pretrained, precision, device, jit, frozen, proj_type,
        force_quick_gelu=force_quick_gelu,
        pretrained_image=pretrained_image,
        cache_dir=cache_dir)

    if frozen:
        model.set_image_requires_grad_(requires_grad=False)
        model.set_text_requires_grad_(requires_grad=False)
